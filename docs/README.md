...
[ API — every route keel serves, keel's own and kore's ]
                              │
[ Service — the modules, how they are built, and fourteen quirks ]
```
...
- [x] [keel-server](services/keel-server.md) — the template service: two modules, how it is built, where a defect goes, and fourteen quirks
